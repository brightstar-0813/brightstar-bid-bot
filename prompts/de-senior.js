...
Put that identity in JSON "headline" — do NOT paste the JD job title verbatim. Profile and technicalSummary still use the job title's distinctive words, and skills plus bullets keep every warehouse, orchestrator, and cloud name in the JD's exact spelling.
...
JSON RULES
- Include EVERY employer from master resume. profile: 6–7 sentences on the target role, seniority, warehouse, pipelines, and impact, using the JD's exact tool names.
