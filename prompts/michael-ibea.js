...
Rewrite Michael Haries Namuco Ibea's resume for ONE target job description using the verified profile, career history, and company context supplied below.

Your highest priority is not generic Salesforce wording. It is this: a recruiter reading the resume must immediately think "this candidate has already done work very similar to what we need" — because every important requirement in the JD that Michael genuinely supports is visible in the Skills section AND proven inside Professional Experience with a real project, his personal responsibility, and an outcome.
...
Ignore any stored memory, earlier conversation, or personal detail about this candidate that is not written in this prompt. This prompt is the complete and only source of truth about Michael. If you "remember" a fact about him that is not below, it does not exist.
...
GATE 1A — THE TWO MOST RECENT ROLES MUST PROVE THE MUST-HAVES. Intrado Life & Safety Inc and Smart Park Inc each carry AT LEAST 3 bullets that name the JD's required skills and describe real work with them — not one bullet listing all of them, but three separate bullets spread across different workflows. The skills table alone is worthless: a recruiter checks whether the recent roles actually did the work. If Data Cloud and Agentforce are required and neither appears in a Intrado Life & Safety Inc bullet, the resume has failed no matter how good the skills row looks.
Priority order inside those bullets: the skills the JD marks MUST have first, then the rest of the required list. A required skill that is already common in Michael's history (Apex, Service Cloud) does NOT satisfy this gate on its own — the scarce, newly required products must each appear in at least one recent-role bullet.
Where a product postdates a role, put it in Intrado Life & Safety Inc rather than Smart Park Inc, and give Smart Park Inc the era-appropriate members of the required list instead.
...
GATE 7 — HOLD THE FIXED FACTS. Employers, dates, locations, titles, education, and the certification list stay exactly as given, in the given order. Experience framing stays 10+ years in technology including 8+ years of Salesforce delivery.
...
Then classify every Tier 1 and Tier 2 requirement against Michael's real background:
...
Tier 0 is NOT run through this classification and NOT run through the COVERAGE LADDER. Whether or not the material below mentions a Tier 0 skill, it goes into the resume as a skill Michael has. See TIER 0 TREATMENT.
...
- what Michael personally designed, built, configured, integrated, migrated, secured, tested, deployed, debugged, or documented,
...
- Intrado Life & Safety Inc (current role): roughly 60-70% of the strongest JD-aligned themes.
- Smart Park Inc: deep CRM and operations themes, plus reinforcement of top Tier 1 keywords where believable.
- Clibase Technology Inc: foundational Salesforce development and ecommerce CRM ownership in the Philippines.
- App It: junior Salesforce and software engineering internship foundation only. Never convert this into a senior architecture role.
...
Write every Tier 0 skill as a skill Michael has — flat, in the same voice as every other skill, with no hedge, no parenthetical softener, and no distancing verb. Do not write "exposure to Data Cloud", "working knowledge of Agentforce", "familiar with", "evaluated", "designed toward", "proof of concept", "(basic)", or "learning". A hedged must-have reads as an admission and fails the screen exactly as an omission does. Either the skill is on the resume as a skill, or the application is not worth sending.

Give Tier 0 experience bullets the same specificity demanded everywhere else in this prompt: the real employer's real business process, exact feature names, what Michael personally built, and the result. A vague Tier 0 bullet is worse than none — it announces that the keyword was bolted on. If a Tier 0 bullet could be pasted into any other candidate's resume unchanged, rewrite it.
...
- Agentforce, Einstein Copilot, Prompt Builder, Agent Builder, Einstein Trust Layer: late 2024 onward — Intrado Life & Safety Inc ONLY.
- Salesforce Data Cloud (and its Genie / Customer 360 Audiences lineage): 2023 onward — Intrado Life & Safety Inc; Smart Park Inc only in late-tenure bullets.
- Salesforce-native Document Generation: 2023 onward — Intrado Life & Safety Inc. Conga Composer and Nintex Drawloop date to the early 2010s and may appear in older roles where DocGen is the requirement.
- Public Sector Solutions, OmniStudio: 2021 onward — Intrado Life & Safety Inc and Smart Park Inc.
- CRM Analytics: use that name only for 2021 onward; for earlier work write Einstein Analytics or Wave, and only from 2016.
- Lightning Web Components, Salesforce DX, Salesforce CLI, Gearset, Copado, Flow Builder: 2019 onward — Intrado Life & Safety Inc, Smart Park Inc, and later Clibase Technology Inc years.
- Lightning Experience and Aura: 2016 onward.
- The earliest roles (App It internship and early Clibase Technology Inc) use only what existed then: Salesforce Classic, Visualforce, Apex triggers, workflow rules, approval processes, reports and dashboards, Data Loader, Change Sets.
...
RUNG 5 — FOUNDATION EVIDENCE. An earlier role or adjacent domain proves the underlying competence even though the exact tool differs — the early platform work at App It supports "relational data modeling and declarative platform fundamentals"; public safety, parking operations, and ecommerce delivery supports high-volume operational and customer-facing contexts.
...
A skills CATEGORY may be named after the JD's theme even when its listed items are Michael's real tools. Naming the category "Integration & Middleware" when the JD says MuleSoft is legitimate framing; adding "MuleSoft" to the list is not.
...
- Contact phone in the JSON must be exactly "+63 948 803 6855". Never substitute another number.
...
THE INTERVIEW TEST — apply to every Tier 1, Tier 2, and Tier 3 line before it ships: could Michael answer three specific follow-up questions about this from real memory, and would it survive a reference check and a technical screen? If not, it belongs on Rung 6.
Tier 0 lines are written to clear the screen and are exempt from this test by design. That exemption comes with an obligation: write them concretely enough that they describe a real, coherent piece of work — specific features, a specific workflow, a specific outcome — so they hold together as a body of work Michael can prepare against before the technical conversation. Vague Tier 0 padding fails both the screen and the interview.
...

{
  ...
  "headline": "Senior Salesforce Application Systems Analyst",
  ...
  "profile": "Senior Salesforce Application Systems Analyst with 10+ years in technology and 8+ years delivering Salesforce solutions across public safety communications, airport parking operations, ecommerce, and digital product teams.",
  "education": [
      {
        "school": "University of Hong Kong",
        "degree": "Bachelor of Science in Computer Science",
        "year": "Sep 2014 - Jun 2018",
        "details": "Pok Fu Lam, Hong Kong"
      }
    ],
  "certifications": [],
  "skills": [
  ...
  "experience": [
    {
      ...
      "location": "Longmont, Colorado, United States | Remote",
      "title": "Senior Salesforce Application Systems Analyst",
      "dates": "Dec 2024 - Present",
      "project": "Enterprise CRM Platform",
      "bullets": [
        "Built Salesforce Service Cloud case routing with Omni-Channel skills-based assignment and entitlement milestones for the support desk."
      ]
    }
  ]
}
...
- linkedin must be exactly: "linkedin": "https://www.linkedin.com/in/michael-haries-ibea-0baa0a417/"
...
- Domain language aligned to Michael's real company contexts plus JD themes
...
- State experience as 10+ years in technology including 8+ years of Salesforce delivery (do not inflate beyond this)
...
- Mention the relevant business domain when supported (public safety communications, airport parking, ecommerce digitalization, mobile and web products)
...
It lists EVERY Salesforce cloud and product the JD names, in the JD's order of emphasis, BEFORE Michael's other clouds. If the JD says "Primary Skill: Service Cloud / Required: Data Cloud, Agentforce, PSS", the row reads:
...
- Include relevant technologies already in Michael's background even when the JD is silent, but keep them subordinate to JD priorities.
- Do not paste the JD's skill list verbatim as a block and do not keyword-dump. Tier 0 terms belong here; the surrounding stack must still be Michael's own.
...
- Use the category names from the approved list above. Do not reproduce the generic category set from Michael's existing resume ("Platform Administration & Security", "Integration & Data", "Analytics", "Technical Leadership") — those are the untailored source, and repeating them is a sign no tailoring happened.
...
- Intrado Life & Safety Inc (Dec 2024 - Present): 10-12 bullets
- Smart Park Inc (Jun 2021 - Oct 2024): 9-11 bullets
- Clibase Technology Inc (Jul 2018 - May 2021): 8-10 bullets
- App It (Jun 2016 - Jun 2018): 3-5 bullets

Set "location"
Set "location" for each role to the exact "City, State, Country | Mode" string from FIXED COMPANY HISTORY.
NEVER append an employment type to the location line. Full-Time, Part-Time, Contract, Contract-to-Hire, Temporary, Intern, Freelance, W2, C2C and every variant are banned from the location line only. Work mode (Hybrid / Remote / On-Site) stays. The App It title must stay exactly "Junior Salesforce Developer / Software Engineer Intern" — the words Junior and Intern are required and must never be stripped.
...
Action verb + specific system, workflow, or business process + exact technology + what Michael personally owned + engineering or business result.
...
5. What did Michael personally design, build, configure, integrate, test, migrate, secure, deploy, debug, or document?
...
DEPTH TARGETS
- Intrado Life & Safety Inc / Smart Park Inc / Clibase Technology Inc: one long sentence each, roughly 150-260 characters, naming a concrete Salesforce artifact.
- App It: roughly 100-170 characters, framed as junior Salesforce and software engineering internship work.
...
When the JD names a technology, show depth instead of the bare name, wherever Michael's history supports it:
...
Use only features consistent with Michael's actual work and with the technology available during that employment period.

==================================================
DEPTH PLAYBOOK — WHEN THE JD LEANS ON AN AREA
==================================================

INTEGRATION DEPTH. When integrations matter, make them one of the strongest areas of the resume, and for each integration bullet identify as many of these as the history supports: source system, target system, the business data exchanged, the integration technology, the authentication method, the payload format, the sync pattern, the error-handling pattern, and what Michael personally owned. Real pairings for his history: Salesforce to ERP and billing platforms, to field-service dispatch and scheduling, to student-information and campus systems, to distributor and inventory systems, to marketing automation, and to data warehouses through MuleSoft.
...
NON-SALESFORCE ROLES. App It may include adjacent web/mobile internship work, but Salesforce configuration support is allowed. Keep bullets junior. Never restyle App It as a senior Salesforce architecture role.
...
Surface real transferable domain experience when the JD belongs to an industry Michael actually served:
- Public safety and emergency communications: Intrado Life & Safety Inc — 911 and emergency response platforms, public safety routing, enterprise communication workflows, vendor screening and compliance, quoting and order systems, internal automation and reporting.
- Airport parking and travel operations: Smart Park Inc — PHL airport parking reservations, shuttle coordination, customer service, loyalty programs, payment and booking management, operational reporting.
- Ecommerce and omni-channel retail: Clibase Technology Inc — Omni-channel ecommerce and digitalization platforms across POS, web store, messenger store, and marketplaces; CRM, inventory, loyalty, campaigns, payments, and analytics.
- Mobile and web product engineering: App It — web and mobile applications, CMS, booking and notification systems, payment integration, Salesforce configuration support during the internship years.

Outside of Tier 0,Outside of Tier 0, do not claim industry regulations, clinical systems, or platforms with no factual basis. Never claim a government agency, program, or contract Michael did not work on, and never claim a clearance.

==================================================
COMPANY CONTEXT (use the real business of each employer)
==================================================

Intrado Life & Safety Inc (Longmont, Colorado, United States | Remote | current):
Public safety communications and emergency technology company founded 1979, 1,001-5,000 employees, IT Services and IT Consulting. Main services: 911 and emergency communication solutions, public safety routing and response systems, enterprise communication workflows, life safety technology platforms, customer/quoting/order and operational systems, vendor screening and compliance workflows, internal business automation and reporting.
Michael's work: senior Salesforce application systems analysis and development across emergency-communications CRM — Service Cloud case and operational workflows, Apex and Lightning Web Components, data architecture, integrations with public-safety and enterprise systems, reporting, release support, and platform automation.

Smart Park Inc (Philadelphia, Pennsylvania, United States | Remote):
Airport parking operator for Philadelphia International Airport (PHL), 11-50 employees, Travel Arrangements. Specialties: airport parking, shuttle service, short- and long-term parking.
Michael's work: Salesforce developer / CRM systems engineer for reservations, shuttle coordination, customer service, loyalty, payment and booking management, operational reporting, Apex and declarative automation, customer portal patterns where historically accurate, and integrations with booking and payment systems.

Clibase Technology Inc (Imus, Cavite, Philippines | On-site):
Omni-channel ecommerce and digitalization solutions company in the Philippines, 11-50 employees, Software Development. Main services: CRM implementation, POS and sales workflows, inventory and order management, loyalty, campaigns, payments, analytics dashboards, client onboarding.
Michael's work: Salesforce developer / CRM platform developer — configuration, Apex and Visualforce then Lightning development as the platform modernised, ecommerce and retail CRM workflows, data cleanup, reporting, and client support. Multi-year tenure — show sustained ownership, not a task list.

App It (Sheung Wan, Hong Kong | On-site | internship):
IT services firm building web and mobile applications, 51-200 employees. Specialties: mobile applications, CMS, maintenance and technical support.
Michael's work: junior Salesforce developer / software engineer intern — Salesforce configuration support, custom CRM development assistance, UI/UX and web/mobile application work, booking and notification systems, payment integration support. Keep this clearly junior; never describe it as senior architecture.
==================================================
CAREER PROGRESSION AND ANTI-OVER-TAILORING
==================================================

- Intrado Life & Safety Inc carries the strongest JD alignment, the broadest ownership, and the clearest senior-engineering voice.
- Smart Park Inc is the mid-senior CRM ownership role: reservations, operations, customer lifecycle.
- Clibase Technology Inc shows multi-year hands-on Salesforce development in ecommerce and retail CRM.
- App It shows early Salesforce and software engineering internship foundation only.
- Never place modern tooling in a historical role before it plausibly existed there (no Data Cloud, Agentforce, LWC, or Flow Builder in the 2016-2018 App It years; use Visualforce, Apex triggers, workflow rules, approval processes, and Data Loader instead).
- Do not make every role contain every JD keyword, do not copy JD sentences, and do not recreate the target company's product as if Michael already built it.
...
Technical specificity outranks numbers. Include at most 1-2 modest, defensible metric-style results in the Intrado Life & Safety Inc role and optionally one in Smart Park Inc or Clibase Technology Inc, only when natural. Prefer qualitative outcomes: reduced manual processing, fewer recurring defects, cleaner releases, faster troubleshooting, improved data accuracy, stronger access control, better integration stability. Never claim revenue impact, team size, user counts, or large percentage gains.
...
Email: michaelhariesibea3@gmail.com
LinkedIn: https://www.linkedin.com/in/michael-haries-ibea-0baa0a417/
Base identity: Senior Salesforce Application Systems Analyst / Salesforce Developer
Experience framing: 10+ years of overall technology experience, including 8+ years delivering Salesforce solutions across public safety communications, airport parking operations, ecommerce digitalization, and digital product teams.
...
Intrado Life & Safety Inc (Longmont, Colorado, United States | Remote) — default title: Senior Salesforce Application Systems Analyst / Salesforce Developer | Dec 2024 - Present

Smart Park Inc (Philadelphia, Pennsylvania, United States | Remote) — default title: Salesforce Developer / CRM Systems Engineer | Jun 2021 - Oct 2024

Clibase Technology Inc (Imus, Cavite, Philippines | On-site) — default title: Salesforce Developer / CRM Platform Developer | Jul 2018 - May 2021

App It (Sheung Wan, Hong Kong | On-site) — default title: Junior Salesforce Developer / Software Engineer Intern | Jun 2016 - Jun 2018
==================================================
EXISTING TECHNICAL COVERAGE (draw selectively; never dump all of it)
==================================================

Salesforce clouds and products Michael works across:
Sales Cloud, Service Cloud, Experience Cloud, Data Cloud, Agentforce, Einstein AI, Commerce Cloud, CRM Analytics, Salesforce Platform, MuleSoft Integration Cloud.
...
- Platform administration, configuration, security model, and Salesforce fundamentals

This list is the baseline, not a ceiling. It does not limit Tier 0: a JD must-have that is absent from this list still goes into the resume under TIER 0 TREATMENT, placed in an era-appropriate role. Intrado Life & Safety Inc's current work is the natural home for the modern Salesforce stack — Data Cloud, Agentforce and the Einstein Trust Layer, Public Sector Solutions, OmniStudio, Document Generation, Salesforce-native AI — and its business context supports that work plausibly.
...
0g2. RECENT-ROLE PROOF — count, per role, how many Intrado Life & Safety Inc bullets and how many Smart Park Inc bullets name a required skill. Both counts must be 3 or more, and every scarce required product must appear in at least one recent-role bullet. If either count is short, add bullets until it is met before returning.
0h. NO EMPLOYMENT TYPE IN LOCATION — search every experience location for "Full-Time", "Full Time", "Part-Time", "Contract", "Temporary", "Intern", "Freelance", "W2", "C2C" and remove it from location only. Each location reads "City, State, Country | Mode" and nothing more. Keep title exactly "Junior Salesforce Developer / Software Engineer Intern" for App It.
...
0c. ERA CHECK — no Tier 0 or modern skill sits in a role that predates it. Agentforce and Data Cloud appear at Intrado Life & Safety Inc only.
...
4b. TAILORING PROOF — the skills table and the Intrado Life & Safety Inc bullets are visibly specific to THIS JD, not a restatement of Michael's existing resume.
5. RESPONSIBILITY — every bullet shows what Michael personally did.
...
11. INTERVIEW TEST — every Tier 1/2/3 bullet is one Michael could explain from memory. Tier 0 bullets are exempt from this check (see TIER 0 TREATMENT); they must instead be concrete and internally coherent. Never delete a Tier 0 bullet for failing this test — rewrite it with sharper detail.
