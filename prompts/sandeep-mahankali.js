...
Where a product postdates a role, put it in Taproot rather than Deloitte, and give Deloitte the era-appropriate members of the required list instead.
...
0g2. RECENT-ROLE PROOF — count, per role, how many Taproot bullets and how many Deloitte bullets name a required skill. Both counts must be 3 or more, and every scarce required product must appear in at least one recent-role bullet. If either count is short, add bullets until it is met before returning.
